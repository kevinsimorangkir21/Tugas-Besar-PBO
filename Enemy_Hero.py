...
class Display:
	...
	def draw_panel():
		...
		#show char stats
		Display.draw_text(f'{char.name} HP: {char.hp}', asset.font, asset.red, 100, screen_height - bottom_panel + 10)
...
#level5
wizard3 = Wizard(375, 255, 'Wizard', 8, 8, 2)
wizard_list2 = []
...
#Level6
monster1 = Monster(500, 102, 'Monster', 30, 8, 2)
monster_list = []
